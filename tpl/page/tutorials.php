...
<div class="module">
    ...
    <div class="content">
        <div class="box">
            Hi, here we want to give beginners a kind of help. We will add tutorials here for different types of challenges so you can get an idea of them.
            After reading one of the tutorials you should be able to solve at least one of our challenges of the specified category. The aim of this site is not
            to show you how you can devastate homepages or do some real hacking. But it is very important to know how to program secure HTML, JavaScript, Perl
            or PHP applications.<br/>
            But now let's start :-)
        </div>
    </div>
    ...
    <div class="content">
        <div class="box">
            <ul class="com_list1">
                ...
                <li><a href="https://www.watchfire.com/securearea/whitepapers.aspx?id=8" target="_blank">HTTP Response Splitting, Web Cache Poisoning Attacks,
                ...
                <li><a href="http://www.net-security.org/dl/articles/AdvancedXSS.pdf" target="_blank">Advanced cross site scripting and client automation</a>
                </li>
                ...
                <li><a href="http://www.appsecinc.com/presentations/Manipulating_SQL_Server_Using_SQL_Injection.pdf" target="_blank">Manipulating Microsoft SQL
                        Server Using SQL Injection</a></li>
