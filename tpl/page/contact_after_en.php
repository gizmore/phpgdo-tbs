  ...
  <dl>
   <dt>Don'ts</dt>
    ...
    <dt>Security/Hacking</dt>
     ...
     (<a target="_blank" href="<?=$web?>GDO/TBS/tutorials/tbs_wiwa.txt" class="tbscode_standard_link" title="Visit this hyperlink! (Target: tutorials/tbs_wiwa.txt)"><img src="<?=$web?>GDO/TBS/images/misc/tbsc_hyperlink.gif" width="16" height="16" class="tbscode_standard_link" alt="link" title="Visit this hyperlink! (Target: /tutorials/tbs_wiwa.txt)" />web-application</a>).
    ...
    <dt>Support/Donations/Challenges/Tutorials/etc</dt>
     <dd>
      Please go to <a href="<?=$web?>index.php?mo=TBS&me=Support" class="tbscode_standard_link" title="Visit this hyperlink! (Target: /support.php)"><img src="<?=$web?>GDO/TBS/images/misc/tbsc_hyperlink.gif" width="16" height="16" class="tbscode_standard_link" alt="link" title="Visit this hyperlink! (Target: /support.php)" />Support Us</a>
   ...
   <dd>
      ...
      <a href="<?=$web?>GDO/TBS/userdata.php" class="tbscode_standard_link" title="Visit this hyperlink! (Target: /userdata.php)"><img src="<?=$web?>GDO/TBS/images/misc/tbsc_hyperlink.gif" width="16" height="16" class="tbscode_standard_link" alt="link" title="Visit this hyperlink! (Target: /userdata.php)" />userdata</a>
      script.<br />
