...
$of = $path . 'overflows/';
$sx = $path . 'scripts/';
$board = GDO_ForumBoard::getBy('board_title', 'Vulnerable Code');
$href = $board ? $board->hrefView() : href('Forum', 'Boards');
    ...
    <div class="content">
        <div class="box">
            <ul class="com_list1">
                ...
                <li><a href="http://www.php-spezial.de/zip/phpvoting-2.5.zip" target="_blank">FotoVoting 1.2 - 2.5
                        [remote link] [de]</a></li>
            </ul>
        </div>
    </div>
